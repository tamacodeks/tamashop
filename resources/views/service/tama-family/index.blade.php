...
@section('content')
    @include('layout.breadcrumb',['data' => [
        ['name' => "Tama Family",'url'=> '','active' => 'yes']
    ]])
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('service.tama_family_header') }}</div>
                    <div class="panel-body" id="loader">
                        <form id="frmTamaFamily" class="form-horizontal" action="{{ secure_url('tama-family/confirm/order') }}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <a href="#" class="btn btn-primary" id="check_balance">check&nbsp<i class="fa fa-money-bill-alt"></i></a>
    ...
    <script>
        ...
        function triggerFetchBalance() {
            if ($.trim(telInput.val())) {
                if (telInput.intlTelInput("isValidNumber")) {
                    ...
                    var url = "{{ URL::to('tama-family/balance') }}";
                    $.ajax({
                        method: "POST",
                        url: url,
                        ...
                        beforeSend: function () {
                            ...
                            $(".loader").remove();
                            console.log("Current Balance is: ",data);
                            var obj = data;
        ...
        $(document).ready(function () {
            ...
            $("#frmTamaFamily").submit(function(e){
                e.preventDefault();
                ...
                if(amount == '')
                {
                    ...
                    $.confirm({
                        ...
                        content: "{{ trans('service.tf_ask_top1up1') }} "+number+"  {{ trans('service.tf_ask_top1up2') }} &euro;"+amount+"?",
