...
class TransferCallback extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'refund:TransferCallback';
     ...
     * @var string
     */
    protected $description = 'fetch failed transfer to from tama demat';
...
//        try{
        ...
        $response = $dingTTClient->request("GET", "topup/callback/transfer", [
            'headers' => [
